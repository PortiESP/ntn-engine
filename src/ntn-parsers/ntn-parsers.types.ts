...
type T_ParsedBlockTable    = T_ParsedBlockBase & { type: "table"; has_column_header: boolean; has_row_header: boolean; rows: string[][]; rows_html: string[][] }
type T_ParsedBlockTableRow = T_ParsedBlockBase & { type: "table_row"; cells: string[]; cells_html: string[] }
